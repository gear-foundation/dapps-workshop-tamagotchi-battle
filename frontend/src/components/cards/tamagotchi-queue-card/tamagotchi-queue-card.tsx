...
export const TamagotchiQueueCard = ({ className, tamagotchi, asPlayer, isActive }: TamagotchiQueueCardProps) => {
  ...
  return (
    <div
      ...
      {dead && (
        <SpriteIcon name="message-rip"
                    className="absolute top-2 right-3 xxl:top-10 xxl:right-2 w-5 xxl:w-6 aspect-square" />
      )}
      <div
        className="relative w-14 xxl:w-24 aspect-square m-auto rounded-full overflow-hidden bg-white ring-white ring-4 ring-opacity-10">
        <TamagotchiAvatar
